...
class Users extends \Phalcon\Mvc\Model
{
    ...
    /**
    * Check if user has this fuse
    *
    * @return bool
    */
    public function hasFuse(string $fuseright): bool
    {
        $requiredFuse = new UserFuses($fuseright);
        $fuses = UserFuses::forRole(UserRole::fromIndex($this->rank));

        foreach ($fuses as $fuse) {
            if ($fuse->equals($requiredFuse)) {
                return true;
            }
        }
